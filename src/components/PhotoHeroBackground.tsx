  ...
  return (
    <>
      <div className="herlane-photo-hero-bg herlane-photo-hero-bg-light" aria-hidden="true">
        <Image src="/images/hero-light.jpg" alt="" fill priority sizes="100vw" style={{ objectFit: "cover", objectPosition }} />
      </div>
      <div className="herlane-photo-hero-bg herlane-photo-hero-bg-dark" aria-hidden="true">
        <Image src="/images/hero-dark.jpg" alt="" fill priority sizes="100vw" style={{ objectFit: "cover", objectPosition }} />
      </div>
